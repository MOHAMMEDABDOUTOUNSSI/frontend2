...
@Component({
  selector: 'app-horaire-travaille-validation-create-admin',
  templateUrl: './horaire-travaille-validation-create-admin.component.html'
})
export class HoraireTravailleValidationCreateAdminComponent extends AbstractCreateController<HoraireTravailleValidationDto, HoraireTravailleValidationCriteria, HoraireTravailleValidationService>  implements OnInit {

...
@Component({
  selector: 'app-operateur-quota-edit-admin',
  templateUrl: './operateur-quota-edit-admin.component.html'
})
export class OperateurQuotaEditAdminComponent extends AbstractEditController<OperateurQuotaDto, OperateurQuotaCriteria, OperateurQuotaService>   implements OnInit {

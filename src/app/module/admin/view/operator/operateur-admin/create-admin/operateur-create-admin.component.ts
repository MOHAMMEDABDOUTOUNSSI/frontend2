...
export class OperateurCreateAdminComponent extends AbstractCreateController<OperateurDto, OperateurCriteria, OperateurService>  implements OnInit {
   ...
   private _validOperateurCin = true;
    ...
    validateOperateurHoraireTravailleValidations(){
        this.errorMessages = new Array();
    ...
    public validateOperateurAgendasAgenda(){
    ...
    public validateOperateurAgendasOperateur(){
    ...
    public validateOperateurAgendasHeureDebut(){
    ...
    public validateOperateurAgendasHeureFin(){
    ...
    public validateOperateurHoraireTravailleValidationsOperateur(){
    ...
    public validateOperateurHoraireTravailleValidationsHeureDebut(){
    ...
    public validateOperateurHoraireTravailleValidationsHeureFin(){
    ...
    public validateOperateurQuotasOperateur(){
    ...
    public validateOperateurQuotasPrestation(){
    ...
    public validateOperateurQuotasNombreMaxRdv(){
    ...
    const isPermistted = await this.roleService.isPermitted('Agenda', 'add');
    if(isPermistted) {
    ...
    const isPermistted = await this.roleService.isPermitted('HoraireTravailleValidation', 'add');
    if(isPermistted) {
    ...
    const isPermistted = await this.roleService.isPermitted('CelluleValidation', 'add');
    if(isPermistted) {
         this.celluleValidation = new CelluleValidationDto();

...
@Component({
  selector: 'app-cellule-validation-edit-admin',
  templateUrl: './cellule-validation-edit-admin.component.html'
})
export class CelluleValidationEditAdminComponent extends AbstractEditController<CelluleValidationDto, CelluleValidationCriteria, CelluleValidationService>   implements OnInit {

...
@Component({
  selector: 'app-operateur-agenda-create-admin',
  templateUrl: './operateur-agenda-create-admin.component.html'
})
export class OperateurAgendaCreateAdminComponent extends AbstractCreateController<OperateurAgendaDto, OperateurAgendaCriteria, OperateurAgendaService>  implements OnInit {

...
@Component({
  selector: 'app-agenda-create-admin',
  templateUrl: './agenda-create-admin.component.html'
})
export class AgendaCreateAdminComponent extends AbstractCreateController<AgendaDto, AgendaCriteria, AgendaService>  implements OnInit {

...
@Component({
  selector: 'app-operateur-horaire-travaille-validation-create-admin',
  templateUrl: './operateur-horaire-travaille-validation-create-admin.component.html'
})
export class OperateurHoraireTravailleValidationCreateAdminComponent extends AbstractCreateController<OperateurHoraireTravailleValidationDto, OperateurHoraireTravailleValidationCriteria, OperateurHoraireTravailleValidationService>  implements OnInit {

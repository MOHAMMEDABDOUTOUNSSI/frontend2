...
@Component({
  selector: 'app-demande-rdv-edit-admin',
  templateUrl: './demande-rdv-edit-admin.component.html'
})
export class DemandeRdvEditAdminComponent extends AbstractEditController<DemandeRdvDto, DemandeRdvCriteria, DemandeRdvService>   implements OnInit {
    ...
    public prepareEdit() {
        this.item.dateDemandeRdv = this.demandeRdvService.format(this.item.dateDemandeRdv);
        this.item.datePrevu = this.demandeRdvService.format(this.item.datePrevu);
        this.item.dateEffective = this.demandeRdvService.format(this.item.dateEffective);
        this.item.dateValidation = this.demandeRdvService.format(this.item.dateValidation);
        this.item.dateRejet = this.demandeRdvService.format(this.item.dateRejet);
    }

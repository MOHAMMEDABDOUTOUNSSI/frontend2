...
export class UniteAdministrativeCreateAdminComponent extends AbstractCreateController<UniteAdministrativeDto, UniteAdministrativeCriteria, UniteAdministrativeService>  implements OnInit {
   ...
   private _validUniteAdministrativeCode = true;
    ...
    public validatePrestationsLibelle(){
    ...
    public validatePrestationsCode(){
    ...
    public validatePrestationsTypePrestation(){
    ...
    public validatePrestationsDureeEnMiniute(){
    ...
    const isPermistted = await this.roleService.isPermitted('Hopital', 'add');
    if(isPermistted) {
         this.hopital = new HopitalDto();

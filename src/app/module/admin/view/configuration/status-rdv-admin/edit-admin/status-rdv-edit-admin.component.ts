...
@Component({
  selector: 'app-status-rdv-edit-admin',
  templateUrl: './status-rdv-edit-admin.component.html'
})
export class StatusRdvEditAdminComponent extends AbstractEditController<StatusRdvDto, StatusRdvCriteria, StatusRdvService>   implements OnInit {

...
@Component({
  selector: 'app-cause-rejet-demande-rdv-create-admin',
  templateUrl: './cause-rejet-demande-rdv-create-admin.component.html'
})
export class CauseRejetDemandeRdvCreateAdminComponent extends AbstractCreateController<CauseRejetDemandeRdvDto, CauseRejetDemandeRdvCriteria, CauseRejetDemandeRdvService>  implements OnInit {
